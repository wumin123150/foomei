							...
							<div class="widget-body">
								<div class="widget-main">
									<h4 class="header green lighter bigger">
										<i class="ace-icon fa fa-coffee green"></i> 用户注册
									</h4>

									<div class="space-6"></div>

									<form id="login-form" action="${ctx}/register" method="post">
										<fieldset>
											<div class="form-group">
												<label class="block clearfix"> 
													<span class="block input-icon input-icon-right"> 
														<input id="mobile" name="mobile" value="${mobile}" type="text" class="form-control" placeholder="手机号码" style="ime-mode: disabled;" autocomplete="off" onKeypress="javascript:if(event.keyCode == 32)event.returnValue = false;"/> 
											...
											<div class="form-group">
												<label class="block clearfix">
													<span class="block input-icon input-icon-right">
														<input id="name" name="name" type="text" value="${name}" class="form-control" placeholder="姓名" />
											...
											<div class="form-group">
												<label class="block clearfix">
													<span class="block input-icon input-icon-right">
														<input id="captcha" name="captcha" type="text" class="form-control" placeholder="验证码" style="ime-mode:disabled; width:58%!important; display:inline!important;" autocomplete="off" />
														<button id="captchaButton" type="button" class="btn btn-sm btn-primary" onclick="sendCaptcha();">
											...
											<div class="form-group">
												<label class="block clearfix">
													<span class="block input-icon input-icon-right">
														<input id="password" name="password" type="password" class="form-control" placeholder="密码" onKeypress="javascript:if(event.keyCode == 32)event.returnValue = false;"/>
											...
											<div class="form-group">
												<label class="block clearfix">
													<span class="block input-icon input-icon-right">
														<input id="repassword" name="repassword" type="password" class="form-control" placeholder="确认密码" onKeypress="javascript:if(event.keyCode == 32)event.returnValue = false;"/>
														<i class="ace-icon fa fa-retweet"></i>
													</span>
												</label>
											</div>
											<label class="block">
												<input type="checkbox" id="agreement" name="agreement" class="ace">
												<span class="lbl">
													我已阅读并接受
													<a href="${ctx}/protocal" target="_blank">《用户协议》</a>
												</span>
											</label>
											<div id="error-info" class="text-danger"><c:if test="${not empty error}"><i class='fa fa-times-circle'></i>${error.defaultMessage}</c:if>&nbsp;</div>
