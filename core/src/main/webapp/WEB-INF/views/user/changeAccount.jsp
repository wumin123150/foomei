				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<form class="form-horizontal" id="validation-form" action="${ctx}/${action}/changeAccount" method="post" role="form">
								...
								<div class="row"> 
									<div class="col-xs-12 col-sm-6">
										<div class="form-group">
											<label class="col-xs-12 col-sm-3 control-label no-padding-right" for="form-mobile"> 手机<span class="input-required">*</span> </label>
											<div class="col-xs-12 col-sm-8">
									...
									<div class="col-xs-12 col-sm-6">
										<div class="form-group">
											<label class="col-xs-12 col-sm-3 control-label no-padding-right" for="form-email"> 邮箱<span class="input-required">*</span> </label>
											<div class="col-xs-12 col-sm-8">
												<div class="input-group">
													<span class="input-group-addon">
