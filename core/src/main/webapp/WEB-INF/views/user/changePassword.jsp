				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<form class="form-horizontal" id="validation-form" action="${ctx}/${action}/changePwd" method="post" role="form">
									...
									<div class="col-xs-12 col-sm-6">
										<div class="form-group">
											...
											<div class="col-xs-12 col-sm-8">
												<div class="clearfix">
													<input type="text" name="loginName" value="${user.loginName}" id="form-loginName" placeholder="用户名" class="form-control" disabled/>
												</div>
											</div>
										</div>
									</div>
