						...
						<div class="col-xs-12">
							<form class="form-horizontal" id="validation-form" role="form">
								...
								<div class="row"> 
									<div class="col-xs-12">
										<div class="form-group">
											<label class="col-xs-12 col-sm-3 control-label no-padding-right" for="form-url"> 地址<span class="input-required">*</span> </label>
								...
								<div class="row"> 
									<div class="col-xs-12">
										<div class="form-group">
											<label class="col-xs-12 col-sm-3 control-label no-padding-right" for="form-type"> 操作<span class="input-required">*</span> </label>
											<div class="col-xs-12 col-sm-8">
												<div class="clearfix">
								...
								<div class="row"> 
									<div class="col-xs-12">
										<div class="form-group">
											...
											<div class="col-xs-12 col-sm-8">
												<div class="clearfix">
													<textarea name="result" id="form-result" placeholder="返回结果 " class="form-control" rows="5" readonly></textarea>
												</div>
											</div>
										</div>
									</div>
