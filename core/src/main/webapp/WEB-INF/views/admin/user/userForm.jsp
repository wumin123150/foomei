      ...
      <div class="page-content">
        ...
        <div class="row">
          <div class="col-xs-12">
            ...
            <form class="form-horizontal" id="validation-form" action="${ctx}/admin/user/${action}" method="post" role="form" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-8">
                      <div class="clearfix">
                        ...
                        <input type="text" name="groupNames" value="${user.groupNames}" id="form-group" readonly data-placeholder="机构" class="form-control" style="background: #fff!important;" onclick="showMenu();" />
              ...
              <div class="clearfix form-actions">
                <div class="col-sm-offset-4 col-sm-8 col-xs-offset-3 col-xs-9">
                  <button class="btn btn-info btn-sm" type="submit"><i class="ace-icon fa fa-check bigger-110"></i> 保存</button> &nbsp; &nbsp; &nbsp;
                  <button class="btn btn-sm" type="reset" onclick="history.back()"><i class="ace-icon fa fa-undo bigger-110"></i> 返回</button>
                </div>
              </div>
            </form>
            <!-- PAGE CONTENT ENDS -->
...
<pageJs>
	...
	<script type="text/javascript">
  	...
  	function onBodyDown(event) {
    	...
    	$("#pwdDiv").hide();$("#form-password").prop("disabled", true);$("#form-repassword").prop("disabled", true);$("#form-status").change(function() {
				...
				rules: {
					loginName:{
						...
						remote: {
							...
							dataType:'json',
							data:{id:function(){return $('#id').val();},loginName:function(){return $('#form-loginName').val();}}
						}
					},
					name:{
						required: true,
