			...
			<div class="main-content-inner">
              ...
              <div class="tab-content">
                <div id="home" class="tab-pane fade active in">
                  <div class="right-content">
                    ...
                    <div class="dataTables_filter input-group">
                      <input type="text" id="searchKey1" name="searchKey1" value="${searchKey}" class="input-sm" placeholder="" aria-controls="datatables">
                      <input type="hidden" id="parentId" name="parentId" />
                      <input style="display:none" />
                      <span class="input-group-btn">
                        <button id="btn-search1" class="btn btn-xs btn-purple" type="button"><i class="fa fa-search"></i>查询</button>
                      </span>
                    </div>
                    </form>
                  </div>
                ...
                <div id="auth" class="tab-pane fade">
                  ...
                  <div class="dataTables_filter input-group">
                    <input type="text" id="searchKey2" name="searchKey2" value="${searchKey}" class="input-sm" placeholder="账号、姓名、手机" aria-controls="datatables">
              ...
              <div id="dialog-container" class="hide">
  							<div id="dialog-form1">
  								...
  								<div class="form-group">
  									<label class="col-xs-12 col-sm-3 control-label no-padding-right" for="form-code"> 机构编码<span class="input-required">*</span> </label>
  								...
  								<div class="form-group">
  									<label class="col-xs-12 col-sm-3 control-label no-padding-right" for="form-name"> 机构名称<span class="input-required">*</span> </label>
  									<div class="col-xs-12 col-sm-8">
  										<div class="clearfix">
                  ...
                  <div class="form-group">
                    <label class="col-xs-12 col-sm-3 control-label no-padding-right" for="form-type"> 机构类型<span class="input-required">*</span> </label>
                    <div class="col-xs-12 col-sm-8">
                      <div class="clearfix">
...
<pageJs>
	...
	(function ($) {
		...
		$.fn.select2.locales['zh-CN'] = {
			...
			formatAjaxError: function (jqXHR, textStatus, errorThrown) { return "获取结果失败"; },
			...
			rules: {
				code:{
					...
					remote:{
						...
						dataType:'json',
						data:{id:function(){return $('#id').val();},code:function(){return $('#form-code').val();}}
					}
				},
				name:{
					required: true,
		  ...
		  navAdd: [
		    {
  				...
  				onClickButton: function(){addForm();},
  				position:'first'
				}
		  ]
		});
			  ...
			  navAdd: [
			    {
	  				...
	  				title:'添加',
	  				buttonicon:'ace-icon fa fa-plus-circle purple',
	  				onClickButton: function(){addForm2();},
	  				position:'first'
					}
			  ]
			});
