			...
			<div class="main-content-inner">
				...
				<div class="breadcrumbs" id="breadcrumbs">
					...
					<ul class="breadcrumb">
						...
						<li class="active"><c:choose><c:when test='${action == "create"}'>新增角色</c:when><c:when test='${action == "update"}'>修改角色</c:when></c:choose></li>
					</ul><!-- /.breadcrumb -->
				</div>
									...
									<div class="col-xs-12 col-sm-6">
										<div class="form-group">
											...
											<div class="col-xs-12 col-sm-8">
												<div class="clearfix">
													<input type="text" name="code" value="${role.code}" id="form-code" placeholder="编码" class="form-control" />
												</div>
											</div>
										</div>
									</div>
