						...
						<div id="login-box" class="login-box visible widget-box no-border">
							<div class="widget-body">
								<div class="widget-main">
									...
									<div id="message-info" class="text-danger"><i class='ace-icon fa fa-exclamation-triangle'></i>${shiroLoginFailure}</div>
									</c:if>
									...
									<form id="login-form" action="${ctx}/admin/login" method="post">
										...
										<div class="form-group">
											<label class="block clearfix"> 
												<span class="block input-icon input-icon-right"> 
													<input id="username" name="username" value="${username}" type="text" class="form-control" placeholder="手机/邮箱/用户名" style="ime-mode: disabled;" autocomplete="off" onKeypress="javascript:if(event.keyCode == 32)event.returnValue = false;"/> 
										...
										<div class="form-group">
										 ...
										 -->
										<div id="user-error-info" class="text-danger"><c:if test="${not empty error}"><i class='fa fa-times-circle'></i>${error.defaultMessage}</c:if>&nbsp;</div>
