			...
			<div class="main-content-inner">
									...
									<div class="widget-box">
										<div class="widget-header">
											...
											<div class="widget-toolbar no-border">
												<button class="btn btn-minier btn-success" onclick="reloadTree()"><i class="ace-icon fa fa-refresh"></i>刷新</button>
                        <c:if test="${type.editable}">
												<button class="btn btn-minier btn-purple" onclick="addForm()"><i class="ace-icon fa fa-plus-circle"></i>新增</button>
												<button class="btn btn-minier btn-primary" onclick="editForm()"><i class="ace-icon fa fa-pencil"></i>修改</button>
												<button class="btn btn-minier btn-danger" onclick="deleteConfirm()"><i class="ace-icon fa fa-trash-o"></i>删除</button>
                        </c:if>
              ...
              <div id="dialog-container" class="hide">
  							<div id="dialog-form">
  								...
  								<input type="hidden" name="type.id" id="typeId" value="${type.id}"/>
  								<input type="hidden" name="typeCode" id="typeCode" value="${type.code}"/>
  								<input type="hidden" name="parentId" id="parentId"/>
                  <input type="hidden" name="item"/>
  								<div class="form-group">
  									<label class="col-xs-12 col-sm-3 control-label no-padding-right" for="form-code"> 编码<span class="input-required">*</span> </label>
  								...
  								<div class="form-group">
  									<label class="col-xs-12 col-sm-3 control-label no-padding-right" for="form-priority"> 序号<span class="input-required">*</span> </label>
  									<div class="col-xs-12 col-sm-8">
  										<div class="clearfix">
  								...
  								<div class="form-group">
  									<label class="col-xs-12 col-sm-3 control-label no-padding-right" for="form-item"> 无子节点<span class="input-required">*</span> </label>
  									<div class="col-xs-12 col-sm-8">
