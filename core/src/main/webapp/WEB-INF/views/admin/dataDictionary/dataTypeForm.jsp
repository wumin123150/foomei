			...
			<div class="main-content-inner">
				...
				<div class="breadcrumbs" id="breadcrumbs">
					...
					<ul class="breadcrumb">
						...
						<li class="active"><c:choose><c:when test='${action == "create"}'>新增类型</c:when><c:when test='${action == "update"}'>修改类型</c:when></c:choose></li>
					</ul><!-- /.breadcrumb -->
				</div>
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<form class="form-horizontal" id="validation-form" action="${ctx}/admin/dataType/${action}" method="post" role="form">
									...
									<div class="col-xs-12 col-sm-6">
										<div class="form-group">
											...
											<div class="col-xs-12 col-sm-8">
												<div class="clearfix">
													<input type="text" name="code" value="${dataType.code}" id="form-code" placeholder="编码" class="form-control" />
												</div>
											</div>
										</div>
									</div>
                  ...
                  <div class="col-xs-12 col-sm-6">
                    <div class="form-group">
                      <label class="col-xs-12 col-sm-3 control-label no-padding-right" for="form-level"> 层级<span class="input-required">*</span> </label>
                      <div class="col-xs-12 col-sm-8">
                        <div class="clearfix">
                          <input type="text" name="level" value="${dataType.level}" id="form-level" placeholder="层级" class="form-control" />
                        </div>
                      </div>
                    </div>
                  </div>
									<div class="col-xs-12 col-sm-6">
										<div class="form-group">
											<label class="col-xs-12 col-sm-3 control-label no-padding-right" for="form-editable"> 数据可修改<span class="input-required">*</span> </label>
											<div class="col-xs-12 col-sm-8">
