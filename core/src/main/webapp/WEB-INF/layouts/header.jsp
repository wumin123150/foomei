    ...
    <div id="bs-navbar" class="navbar-collapse collapse">
      <ul class="nav navbar-nav navbar-right">
        ...
        <shiro:guest>
          ...
          <li id="_nav_login"><a href="${ctx}/login" onclick="_hmt.push(['_trackEvent', 'navbar', 'click', 'login'])">登录</a></li>
          <li class="top_line" id="_nav_register_line"><span>&nbsp;</span></li>
          <li id="_nav_register"><a href="${ctx}/register" onclick="_hmt.push(['_trackEvent', 'navbar', 'click', 'register'])">注册</a></li>
        </shiro:guest>
        <shiro:user>
          ...
          <li class="top_line"><span>&nbsp;</span></li>
          <li id="_nav_logout"><a href="${ctx}/logout" onclick="_hmt.push(['_trackEvent', 'navbar', 'click', 'logout'])"> <i class="ace-icon fa fa-power-off"></i>退出
          </a></li>
        </shiro:user>
      </ul>
    </div>
