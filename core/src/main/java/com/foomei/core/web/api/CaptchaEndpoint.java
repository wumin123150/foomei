...
public class CaptchaEndpoint {
	...
	public Boolean checkCaptcha(@ApiParam(value="手机")String phone, @ApiParam(value="验证码", required=true)String captcha) {
	...
	public ResponseResult sendCaptcha(@ApiParam(value="手机", required=true)String phone) {
		if (StringUtils.isNotEmpty(phone)) {
			send(phone, null);
		} else {
