package com.foomei.common.reflect;
...
public class ClassUtilTest {
	...
	public void getMessage() {
		...
		assertThat(ClassUtil.getPackageName(ClassUtilTest.class)).isEqualTo("com.foomei.common.reflect");
		assertThat(ClassUtil.getPackageName(BClass.class)).isEqualTo("com.foomei.common.reflect");
		assertThat(ClassUtil.getPackageName(ClassUtilTest.class.getName()))
				.isEqualTo("com.foomei.common.reflect");
		assertThat(ClassUtil.getPackageName(BClass.class.getName())).isEqualTo("com.foomei.common.reflect");
	...
	public void classPresent(){
		...
		assertThat(ClassUtil.isPresent("com.foomei.common.reflect.ClassUtil", ClassUtil.getDefaultClassLoader())).isTrue();
	}
