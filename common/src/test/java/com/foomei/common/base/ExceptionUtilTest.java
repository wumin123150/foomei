...
import com.foomei.common.base.ExceptionUtil.CloneableException;
import com.foomei.common.base.ExceptionUtil.CloneableRuntimeException;
import com.foomei.common.base.ExceptionUtil.UncheckedException;
...
public class ExceptionUtilTest {
	...
	public void staticException() {
		assertThat(ExceptionUtil.stackTraceText(TIMEOUT_EXCEPTION)).hasLineCount(2)
				...
				.contains("at com.foomei.common.base.ExceptionUtilTest.hello(Unknown Source)");

		assertThat(ExceptionUtil.stackTraceText(TIMEOUT_EXCEPTION2)).hasLineCount(2)
				.contains("com.foomei.common.base.ExceptionUtil$CloneableException: Timeout")
				.contains("at com.foomei.common.base.ExceptionUtilTest.hello(Unknown Source)");
		...
		assertThat(ExceptionUtil.stackTraceText(timeoutException)).hasLineCount(2)
				.contains("com.foomei.common.base.ExceptionUtil$CloneableException: Timeout for 30ms")
				.contains("at com.foomei.common.base.ExceptionUtilTest.hello(Unknown Source)");

		assertThat(ExceptionUtil.stackTraceText(TIMEOUT_EXCEPTION3)).hasLineCount(2)
				.contains("com.foomei.common.base.ExceptionUtil$CloneableRuntimeException: Timeout")
				.contains("at com.foomei.common.base.ExceptionUtilTest.hello(Unknown Source)");
		...
		assertThat(ExceptionUtil.stackTraceText(timeoutRuntimeException)).hasLineCount(2)
				.contains("com.foomei.common.base.ExceptionUtil$CloneableRuntimeException: Timeout for 40ms")
				.contains("at com.foomei.common.base.ExceptionUtilTest.hello(Unknown Source)");
