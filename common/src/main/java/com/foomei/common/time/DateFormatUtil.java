...
import com.foomei.common.base.annotation.NotNull;
...
public class DateFormatUtil {
  ...
  public static final String PATTERN_STRING_DATE = "yyyyMMdd";
  public static final String PATTERN_STRING_DATETIME = "yyyyMMddHHmmss";
  ...
  public static final FastDateFormat FORMAT_STANDARD = FastDateFormat.getInstance(PATTERN_STANDARD);
  public static final FastDateFormat FORMAT_SHORT = FastDateFormat.getInstance(PATTERN_SHORT);
  public static final FastDateFormat FORMAT_MONTH = FastDateFormat.getInstance(PATTERN_MONTH);
  public static final FastDateFormat FORMAT_YEAR = FastDateFormat.getInstance(PATTERN_YEAR);
  public static final FastDateFormat FORMAT_TIME = FastDateFormat.getInstance(PATTERN_TIME);
  public static final FastDateFormat FORMAT_MINUTE = FastDateFormat.getInstance(PATTERN_MINUTE);
  public static final FastDateFormat FORMAT_STRING_DATE = FastDateFormat.getInstance(PATTERN_STRING_DATE);
  public static final FastDateFormat FORMAT_STRING_DATETIME = FastDateFormat.getInstance(PATTERN_STRING_DATETIME);
  public static final FastDateFormat FORMAT_CHINA = FastDateFormat.getInstance(PATTERN_CHINA);
   ...
   * @param strDate 时间字符串
   */
  public static Date parseStandardDate(String strDate) {
    return str2Date(strDate, FORMAT_STANDARD);
  }
  ...
  public static Date parseShortDate(String strDate) {
    return str2Date(strDate, FORMAT_SHORT);
  }
   ...
   */
  public static Date parseDate(String strDate, @NotNull String pattern) throws ParseException {
    return str2Date(strDate, FastDateFormat.getInstance(pattern));
  }
   ...
   *
   * @param strDate    时间字符串
   * @param dateFormat 时间样式
   */
  public static Date str2Date(String strDate, FastDateFormat dateFormat) {
  ...
  public static String formatStandardDate(Date date) {
    return date2Str(date, FORMAT_STANDARD);
  }
  ...
  public static String formatStringDate(Date date) {
    return date2Str(date, FORMAT_STRING_DATE);
  }
  ...
  public static String formatStringDateTime(Date date) {
    return date2Str(date, FORMAT_STRING_DATETIME);
  }
  ...
  public static String formatDate(Date date, @NotNull String pattern) {
    return date2Str(date, FastDateFormat.getInstance(pattern));
  }

  /**
   * 格式化当前日期, 仅用于pattern不固定的情况.
   */
  public static String formatCurrentDate(String pattern) {
    return formatDate(ClockUtil.currentTimeMillis(), pattern);
  }
   ...
   * @param dateFormat 时间样式
   */
  public static String date2Str(Date date, FastDateFormat dateFormat) {
    if (date != null) {
