...
public class ClassUtil {
  ...
  public static String getPackageName(String className, int len) {
    if (len <= 0) {
    ...
    int endIndex = StringUtils.ordinalIndexOf(packageName, ".", len);
    return endIndex > 0 ? StringUtils.substring(packageName, 0, endIndex) : packageName;
  }
